...
2. Set **Root Directory** to `vercel-lite`. The framework is detected as Next.js, and the defaults work.
3. Deploy. `npm run build` runs `prebuild` first, which downloads GTFS and writes `public/data/`.
